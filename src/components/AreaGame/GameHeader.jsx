  ...
  return (
    <div className="w-full max-w-[600px] mx-auto rounded flex items-center justify-between">
      <button
        ...
        className="group h-10 w-10 flex items-center justify-between shadow-around shadow-slate-600 hover:shadow-slate-500 p-2 rounded-full transition-all duration-200"
      >
